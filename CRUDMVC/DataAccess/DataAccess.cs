...
namespace CRUDMVC.DataAccessLayer
{
    public class DataAccess
    {
        ...
        public List<Customer> Selectalldata()
        {
            ...
            try
            {
                con = new SqlConnection("Server=DESKTOP-B0SDD32\\SQLEXPRESS;Database=usermanagement;Integrated Security=true;User ID=DESKTOP-B0SDD32\\Jesu;Password=");
                SqlCommand cmd = new SqlCommand("Usp_InsertUpdateDelete_Customer", con);
                cmd.CommandType = CommandType.StoredProcedure;
